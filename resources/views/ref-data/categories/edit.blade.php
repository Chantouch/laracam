                    ...
                    <ul class="header-dropdown m-r--5">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li><a href="{!! route('admin.manage.categories.create') !!}">ADD CATEGORY</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                <div class="body">
                    {!! Form::model($category, ['route' => ['admin.manage.categories.update', $category->id], 'method' => 'patch', 'files'=> true]) !!}
